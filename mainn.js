//function setup(){
//    cam=createCanvas(340, 340);
//    cam.center();
//    background("#81BECE");
//    cam.mouseReleased(classifyCanvas);
//}
...
//document.getElementById("sketchDraw").innerHTML="Sketch to be drawn :"+Element_of_array;
//
//timer_counter=0;
//timer_checker="";
//drawn_sketch="";
...
//    document.getElementById("yosketch").innerHTML = "Your Sketch: "+results[0].label;
